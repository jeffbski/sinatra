...
With params and specified regex patterns for some params

  get '/edit/:page', {:param_regex => {:page => '.+'}} do
    # matches /edit/foo/bar sets page to foo/bar
  end

  get '/edit/:page/:rev', {:param_regex => {:page => '.+', :rev => '[a-f0-9]{8}}} do
    # matches /edit/foo/bar/ab345678 sets page to foo/bar, and :rev to ab345678
  end
